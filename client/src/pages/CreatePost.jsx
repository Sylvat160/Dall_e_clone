...
const CreatePost = () => {
  ...
  const [generateImg, setGeerateImg] = useState(false);
    ...
    <section className="max-w-7xl mx-auto ">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[14px] max-w-[500px]">
          Crate imaginative images through a collection of imaginative and
      ...
      <form className="mt-16 mx-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="relative bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 mt-2 w-64 p-3 h-64 flex justify-center items-center">
          ...
          {generateImg && (
            <div className="absolute inset-0 z-0 flex justify-center items-center bg-[#0000015e] rounded-lg">
              <Loader />
            </div>
          )}
        </div>
